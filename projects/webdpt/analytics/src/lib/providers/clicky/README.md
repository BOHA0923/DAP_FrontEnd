...
__import__: `import { AnalyticsClicky } from 'ngx-analytics/clicky';`
...
import { AnalyticsClicky } from 'ngx-analytics/clicky';
...
@NgModule({
  ...
  imports: [
    ...
    NgxAnalyticsModule.forRoot([AnalyticsClicky])
  ],
  providers: [],
...
export class AppComponent {
  // Enable auto route logging
  constructor(ngx-analyticsClicky: AnalyticsClicky) {}
}
```
